// src/modules/person/person.mock.js
...
(function (ng) {
    ...
    mod.run(['$httpBackend', function ($httpBackend) {
             ...
             * ej: api/persons/1
             */
            var recordUrl = new RegExp('api/persons/([0-9]+)');
            ...
            var records = [{
                    id: 48454,
                    username: 'js.cardona12',
                    email: 'js.cardona12@uniandes.edu.co',
                    password:'12345'
                },
                {
                    id: 72561,
                    username: 'js.cardona11',
                    email: 'js.cardona11@uniandes.edu.co',
                    password:'12345'
                }];
             ...
             */
            $httpBackend.whenGET('api/persons').respond(function (method, url) {
             ...
             */
            $httpBackend.whenPOST('api/persons').respond(function (method, url, data) {
