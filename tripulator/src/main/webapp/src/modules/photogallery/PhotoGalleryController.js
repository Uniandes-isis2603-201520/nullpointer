app.controller('PhotoGalleryController', ['$scope', function($scope){
      $scope.photos=[
          ...
          desc:'Muy hermoso.', place: 'Rio de Janeiro'},
          ...
          desc:'No fue tan chevere.', place: 'Madrid'} 
      ];
